...
async def main():
    ...
    if token:
        use_sandbox = input("Use sandbox environment? (y/n, default=y): ").strip().lower()
    ...
    if all([mcp_ok, claude_ok, evernote_ok is not False]):
        print("\n🎉 All tests passed! Your Evernote MCP server is ready to use.")
